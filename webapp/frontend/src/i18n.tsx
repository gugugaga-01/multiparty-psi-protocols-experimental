...
const en: Dict = {
  ...
  'protocol.notBuilt': 'Not built into psi_party: {list} (rebuild with the matching -DMPSI_BUILD_* flag)',
...
const zh: Dict = {
  ...
  'protocol.notBuilt': 'psi_party 未编译: {list}（请用对应的 -DMPSI_BUILD_* 选项重新编译）',
